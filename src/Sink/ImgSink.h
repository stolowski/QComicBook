...
public:
  ...
  /*! Returns abbreviated name of maxlen. This name is not reliable, eg. it
   * can't be used as file or directory name. It is meant for viewing only.
  ...
  /*! @return contents of .nfo and file_id.diz files; file name goes first, then
   * contents. */
