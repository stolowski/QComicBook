...
void ImageTransformJob::setKey(const JobKey &k) { m_key = k; }

const JobKey &ImageTransformJob::key() const { return m_key; }
...
void ImageTransformJob::setMatrix(const QTransform &m) {
  delete m_matrix;
  m_matrix = new QTransform(m);
}
