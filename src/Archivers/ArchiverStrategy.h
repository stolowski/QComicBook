...
/**
 * @brief Base class that provides configuration information and commandline
 * parameters for external archivers.
 */
...
public:
  ...
  /**
   * @brief Return true if specified archive file can be opened with this
   * archiver.
   *
  ...
  /**
   * @brief Fills command line template with given arguments. The returned list
   * is ready for use for archiver process invocation. Special argument @@F is
   ...
   */
  static QStringList fillTemplateArguments(const QStringList &args,
                                           const QString &filename);

  /**
   * @brief Performs configuration of this archiver. Detects if this archiver is
   * supported and sets internal parameters accordingly.
   */
  virtual void configure() = 0;

  /**
   * @brief Provides hints related to configuration and availability of this
   * archiver.
   *
   * @return hints
   */
