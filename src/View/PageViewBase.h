...
private:
  static const float
      JUMP_FACTOR; // factor used to calculate the amount of space to scroll
                   // when scrolling page with space
  QMenu *context_menu;
  int m_physicalPages;
  QPointF last;   // last mouse position when tracking mouse movements
